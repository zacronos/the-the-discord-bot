...
- [X] `assets/bot-icon.svg` + rendered `assets/bot-icon-1024.png` — robot-face app icon, added by request 2026-08-07 ("secret-keeper ballot box": visor = anonymous votes, mouth slot + slip = ballot being cast; palette deliberately avoids red/green). Rendered headlessly at exactly 1024×1024; upload happens in 1.2.
